...
import 'package:beats/screens/uploadPodcastData.dart';
...
class uploadPodcast extends StatefulWidget {
  @override
  uploadPodcastState createState() => uploadPodcastState();
}

class uploadPodcastState extends State<uploadPodcast> {
              ...
              return ListTile(
                trailing: PopupMenuButton<String>(
                  ...
                  itemBuilder: (BuildContext context) {
                    return Constants.mostrarSubirPodcast.map((String choice) {
      ...
      itemBuilder: (BuildContext context, int index) {
        return Padding(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(child: Icon(Icons.music_note, color: Colors.white,), backgroundColor: Colors.purple,),
          ),
        );
      },
    );
